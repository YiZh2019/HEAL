...
**Conclusion:** According to the Dicky - Fuller test, the series is statistically significantly stationary (p = 0.01). So the AR/ MA/ ARMA models would be considered.
