...
# Time Delayed
analysis.data <- mutate(analysis.data, d_rat_delay_time_fixed = ifelse(is.na(redcap_id), D_RAT_time_delayed, d_rat_delay_time))  # not correct, needs to be corrected

sum(!is.na(analysis.data$d_rat_delay_time_fixed))
