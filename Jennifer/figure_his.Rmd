...
```{r}
mydata <- read.csv("/Users/zhan039/Desktop/USC_HEAL/Jennifer/Re__Figure_2/Social Concern study_5_his.csv", stringsAsFactors = FALSE)
...
```{r}
# ggplot
figure_his <- ggplot(newdata2, aes(x = W86_Concern_Soc_average, y = W8_Cig_USE_CT)) +
...
figure_his
loadfonts()
ggsave(figure_his, file = "/Users/zhan039/Desktop/USC_HEAL/Jennifer/Re__Figure_2/YZ/figure_his.pdf")
ggsave(figure_his, file = "/Users/zhan039/Desktop/USC_HEAL/Jennifer/Re__Figure_2/YZ/figure_his.png")
