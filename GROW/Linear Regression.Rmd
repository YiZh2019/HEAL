...
```{r}
# CO
Mean.sd.n(data$nd_co)
Mean.sd.n(data$d_co)
Mean.sd.n(data$DIFF_FS_CO_PreRAT)
Mean.sd.n(data$DIFF_FS_CO_PostR)
Mean.sd.n(data$DIFF_FS_CO_PreR)

data$diff_co <- data$d_co - data$nd_co
Mean.sd.n(data$diff_co)
select(data, d_co, nd_co, diff_co)
t.test(data$d_co, data$nd_co, paired = T)
cohen.d(data$d_co, data$nd_co, paired = T, na.rm = T, within = F)
-35.355/sqrt(597)
# Urge/Craving
# WSWS craving
