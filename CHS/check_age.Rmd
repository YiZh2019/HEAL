...
select(CHS, dobkid, dobkid_new, Y12_SurveyDate_New, Y12_Age, Y12_Age_Calc, Y12_Age_Calc_new)
```
...
select(CHS, dobkid, dobkid_new, Y13_SurveyDate_New, Y13_Age, Y13_Age_Calc, Y13_Age_Calc_new)
```
...
select(CHS, dobkid, dobkid_new, Y14_SurveyDate_New, Y14_Age, Y14_Age_Calc, Y14_Age_Calc_new)
```
...
select(CHS, dobkid, dobkid_new, Y15_SurveyDate_New, Y15_Age, Y15_Age_Calc, Y15_Age_Calc_new)
```

```{r summary}
summary(CHS$Y12_Age_Calc_new)
summary(CHS$Y13_Age_Calc_new)
summary(CHS$Y14_Age_Calc_new)
summary(CHS$Y15_Age_Calc_new)
```
...
```{r}
write.csv(x = CHS, file = "/Users/zhan039/Desktop/USC_HEAL/CHS/Yi/06232020/CHS_06252020.csv")

write_sav(CHS, "/Users/zhan039/Desktop/USC_HEAL/CHS/Yi/06232020/CHS_06252020.sav")
```
