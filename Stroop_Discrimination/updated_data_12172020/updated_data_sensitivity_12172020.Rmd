---
title: "updated_data_12172020_sensitivity"
author: "Yi"
date: "12/18/2020"
...
# write_sav(data, "/Users/zhan039/Desktop/USC_HEAL/Stroop/Yi/updated_data_12172020/Stroop_sensitivity_with_outliers_YZ.sav")
```

```{r}
# outliers (DEFFERENT!!!)
m.RTime <- mean(data$Reaction_Time)  # 825.8295
sd.RTime <- sd(data$Reaction_Time)  # 347.8687
m.RTime  
sd.RTime  
...
# write_sav(data.rm.outliers, "/Users/zhan039/Desktop/USC_HEAL/Stroop/Yi/updated_data_12172020/Stroop_sensitivity_without_outliers_YZ.sav")
```
