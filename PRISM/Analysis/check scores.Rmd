...
```{r}
data <- read_sav("/Users/zhan039/Desktop/USC_HEAL/PRISM/09112020_DataManage/prism_0921_scored.sav")
...
```{r}
write.csv(data, file = "/Users/zhan039/Desktop/USC_HEAL/PRISM/09112020/prism_0923_scored.csv", na = "")
write_sav(data, "/Users/zhan039/Desktop/USC_HEAL/PRISM/09112020/prism_0923_scored.sav")
```
