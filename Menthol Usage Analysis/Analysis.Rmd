...
cohen.d(filter.data.cleanshq1[filter.data.cleanshq1$shq_8 == 1, ]$shq_1, filter.data.cleanshq1[filter.data.cleanshq1$shq_8 == 2, ]$shq_1, paired = F, na.rm = T, within = F, hedges.correction = F)
...
cohen.d(filter.data.combineshq9[filter.data.combineshq9$shq_8 == 1, ]$shq_9, filter.data.combineshq9[filter.data.combineshq9$shq_8 == 2, ]$shq_9, paired = F, na.rm = T, within = F, hedges.correction = F)
...
cohen.d(filter.data.withdraw[filter.data.withdraw$shq_8 == 1, ]$withdraw.count, filter.data.withdraw[filter.data.withdraw$shq_8 == 2, ]$withdraw.count, paired = F, na.rm = T, within = F, hedges.correction = F)
...
cohen.d(filter.data.siblings[filter.data.siblings$shq_8 == 1, ]$sibling.prop, filter.data.siblings[filter.data.siblings$shq_8 == 2, ]$sibling.prop, paired = F, na.rm = T, within = F, hedges.correction = F)
...
# SHAPS
apply(menthol.data[, "SHAPS_RC_Mean"], 2, Mean.SD.N)
apply(unmenthol.data[, "SHAPS_RC_Mean"], 2, Mean.SD.N)
apply(filter.data[, "SHAPS_RC_Mean"], 2, ValidN)
apply(filter.data[, "SHAPS_RC_Mean"], 2, Ttest)
apply(filter.data[, "SHAPS_RC_Mean"], 2, CohensD)
