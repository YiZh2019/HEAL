...
```{r}
data <- read_sav("/Users/zhan039/Desktop/USC_HEAL/Menthol/Merged_GROW_BRAND.sav")
...
menthol.shq1.mean <- mean(menthol.shq.use$shq_1, na.rm = T)
menthol.shq1.sd <- sd(menthol.shq.use$shq_1, na.rm = T)

unmenthol.shq1.mean <- mean(unmenthol.shq.use$shq_1, na.rm = T)
unmenthol.shq1.sd <- sd(unmenthol.shq.use$shq_1, na.rm = T)

filter.out.shq1 <- filter(filter.data, shq_8 == 1 & (shq_1 < (menthol.shq1.mean - 2 * menthol.shq1.sd) | shq_1 > (menthol.shq1.mean + 2 * menthol.shq1.sd)) | shq_8 == 2 & (shq_1 < (unmenthol.shq1.mean - 2 * unmenthol.shq1.sd) | shq_1 > (unmenthol.shq1.mean + 2 * unmenthol.shq1.sd)))
...
# count of races for grandmother (mother's side)
filter.data.race$piq_17_m_gm_dontknow <- NA

filter.data.race[, startsWith(colnames(filter.data.race), "piq_17_m_gm")][, 1:6] <- na_if(filter.data.race[, startsWith(colnames(filter.data.race), "piq_17_m_gm")][, 1:6], 0)

filter.data.race$piq_17_m_gm_count <- apply(filter.data.race[, startsWith(colnames(filter.data.race), "piq_17_m_gm")][, 1:6], 1, sum, na.rm = T)

filter.data.race <- mutate(filter.data.race, piq_17_m_gm_count = ifelse(piq_17_m_gm_count == 0, NA, piq_17_m_gm_count))

filter.data.race$piq_17_m_gm_na <- rowSums(is.na(filter.data.race[, startsWith(colnames(filter.data.race), "piq_17_m_gm")][, 1:7]))

table(filter.data.race$piq_17_m_gm_na)

filter.data.race[, startsWith(colnames(filter.data.race), "piq_17_m_gm")]

Mean.SD.N(filter.data.race[filter.data.race$shq_8 == 1, ]$piq_17_m_gm_count)
Mean.SD.N(filter.data.race[filter.data.race$shq_8 == 2, ]$piq_17_m_gm_count)
ValidN(filter.data.race$piq_17_m_gm_count)

m_gm.levene <- leveneTest(filter.data.race$piq_17_m_gm_count, group = as.factor(filter.data.race$shq_8), center = mean)

m_gm.levene$result[1] <- ifelse(m_gm.levene$`Pr(>F)`[1] < 0.05, FALSE, TRUE)

t.test(filter.data.race[filter.data.race$shq_8 == 1, ]$piq_17_m_gm_count, filter.data.race[filter.data.race$shq_8 == 2, ]$piq_17_m_gm_count, var.equal = m_gm.levene$result[1])

# count of races for grandfather (mother's side)
filter.data.race$piq_17_m_gf_dontknow <- NA

filter.data.race[, startsWith(colnames(filter.data.race), "piq_17_m_gf")][, 1:6] <- na_if(filter.data.race[, startsWith(colnames(filter.data.race), "piq_17_m_gf")][, 1:6], 0)

filter.data.race$piq_17_m_gf_count <- apply(filter.data.race[, startsWith(colnames(filter.data.race), "piq_17_m_gf")][, 1:6], 1, sum, na.rm = T)

filter.data.race <- mutate(filter.data.race, piq_17_m_gf_count = ifelse(piq_17_m_gf_count == 0, NA, piq_17_m_gf_count))

filter.data.race$piq_17_m_gf_na <- rowSums(is.na(filter.data.race[, startsWith(colnames(filter.data.race), "piq_17_m_gf")][, 1:7]))

table(filter.data.race$piq_17_m_gf_na)

filter.data.race[, startsWith(colnames(filter.data.race), "piq_17_m_gf")]

Mean.SD.N(filter.data.race[filter.data.race$shq_8 == 1, ]$piq_17_m_gf_count)
Mean.SD.N(filter.data.race[filter.data.race$shq_8 == 2, ]$piq_17_m_gf_count)
ValidN(filter.data.race$piq_17_m_gf_count)

m_gf.levene <- leveneTest(filter.data.race$piq_17_m_gf_count, group = as.factor(filter.data.race$shq_8), center = mean)

m_gf.levene$result[1] <- ifelse(m_gf.levene$`Pr(>F)`[1] < 0.05, FALSE, TRUE)

t.test(filter.data.race[filter.data.race$shq_8 == 1, ]$piq_17_m_gf_count, filter.data.race[filter.data.race$shq_8 == 2, ]$piq_17_m_gf_count, var.equal = m_gf.levene$result[1])

# count of races for grandmother (father's side)
filter.data.race$piq_17_f_gm_dontknow <- NA

filter.data.race[, startsWith(colnames(filter.data.race), "piq_17_f_gm")][, 1:6] <- na_if(filter.data.race[, startsWith(colnames(filter.data.race), "piq_17_f_gm")][, 1:6], 0)

filter.data.race$piq_17_f_gm_count <- apply(filter.data.race[, startsWith(colnames(filter.data.race), "piq_17_f_gm")][, 1:6], 1, sum, na.rm = T)

filter.data.race <- mutate(filter.data.race, piq_17_f_gm_count = ifelse(piq_17_f_gm_count == 0, NA, piq_17_f_gm_count))

filter.data.race$piq_17_f_gm_na <- rowSums(is.na(filter.data.race[, startsWith(colnames(filter.data.race), "piq_17_f_gm")][, 1:7]))

table(filter.data.race$piq_17_f_gm_na)

filter.data.race[, startsWith(colnames(filter.data.race), "piq_17_f_gm")]

Mean.SD.N(filter.data.race[filter.data.race$shq_8 == 1, ]$piq_17_f_gm_count)
Mean.SD.N(filter.data.race[filter.data.race$shq_8 == 2, ]$piq_17_f_gm_count)
ValidN(filter.data.race$piq_17_f_gm_count)

f_gm.levene <- leveneTest(filter.data.race$piq_17_f_gm_count, group = as.factor(filter.data.race$shq_8), center = mean)

f_gm.levene$result[1] <- ifelse(f_gm.levene$`Pr(>F)`[1] < 0.05, FALSE, TRUE)

t.test(filter.data.race[filter.data.race$shq_8 == 1, ]$piq_17_f_gm_count, filter.data.race[filter.data.race$shq_8 == 2, ]$piq_17_f_gm_count, var.equal = m_gf.levene$result[1])

# count of races for granfather (father's side)
filter.data.race$piq_17_f_gf_dontknow <- NA

filter.data.race[, startsWith(colnames(filter.data.race), "piq_17_f_gf")][, 1:6] <- na_if(filter.data.race[, startsWith(colnames(filter.data.race), "piq_17_f_gf")][, 1:6], 0)

filter.data.race$piq_17_f_gf_count <- apply(filter.data.race[, startsWith(colnames(filter.data.race), "piq_17_f_gf")][, 1:6], 1, sum, na.rm = T)

filter.data.race <- mutate(filter.data.race, piq_17_f_gf_count = ifelse(piq_17_f_gf_count == 0, NA, piq_17_f_gf_count))

filter.data.race$piq_17_f_gf_na <- rowSums(is.na(filter.data.race[, startsWith(colnames(filter.data.race), "piq_17_f_gf")][, 1:7]))

table(filter.data.race$piq_17_f_gf_na)

filter.data.race[, startsWith(colnames(filter.data.race), "piq_17_f_gf")]

Mean.SD.N(filter.data.race[filter.data.race$shq_8 == 1, ]$piq_17_f_gf_count)
Mean.SD.N(filter.data.race[filter.data.race$shq_8 == 2, ]$piq_17_f_gf_count)
ValidN(filter.data.race$piq_17_f_gf_count)

f_gf.levene <- leveneTest(filter.data.race$piq_17_f_gf_count, group = as.factor(filter.data.race$shq_8), center = mean)

f_gf.levene$result[1] <- ifelse(f_gf.levene$`Pr(>F)`[1] < 0.05, FALSE, TRUE)

t.test(filter.data.race[filter.data.race$shq_8 == 1, ]$piq_17_f_gf_count, filter.data.race[filter.data.race$shq_8 == 2, ]$piq_17_f_gf_count, var.equal = f_gf.levene$result[1])

# education
filter.data.edu <- mutate(filter.data, education = ifelse(piq_7 == 1 | piq_7 == 2, 0, 1))
...
edu.chisq <- chisq.test(rbind(table(filter.data.edu[filter.data.edu$shq_8 == 1, ]$education), table(filter.data.edu[filter.data.edu$shq_8 == 2, ]$education)))
...
chisq.test(rbind(table(filter.data[filter.data$shq_8 == 1, ]$piq_8), table(filter.data[filter.data$shq_8 == 2, ]$piq_8)))

# Employment
filter.data.employ <- mutate(filter.data, employ = ifelse(piq_9 == 4, 0, ifelse(piq_9 == 3, 1, ifelse(piq_9 == 1 | piq_9 == 2 | piq_9 == 5, 2, NA))))
...
employ.chisq <- chisq.test(rbind(table(filter.data.employ[filter.data.employ$shq_8 == 1, ]$employ), table(filter.data.employ[filter.data.employ$shq_8 == 2, ]$employ)))
...
income.chisq <- chisq.test(rbind(table(filter.data.income[filter.data.income$shq_8 == 1, ]$income), table(filter.data.income[filter.data.income$shq_8 == 2, ]$income)))
