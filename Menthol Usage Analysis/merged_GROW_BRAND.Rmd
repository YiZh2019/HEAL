...
```{r}
grow <- read_sav("/Users/zhan039/Desktop/USC HEAL/Menthol/fix_grow_data.sav")

brand <- read_sav("/Users/zhan039/Desktop/USC HEAL/Menthol/Nausheen/2.10.20 updated data set with CTSI.sav")
```
...
write_sav(data = merged.data, path = "/Users/zhan039/Desktop/USC HEAL/Menthol/Merged_GROW_BRAND.sav")
```
