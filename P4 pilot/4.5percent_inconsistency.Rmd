---
title: "4.5percent_inconsistency"
author: "Yi"
date: "3/30/2020"
output:
...
# compare each item with 3
prec_cis_bi <- as.data.frame(ifelse(prec_cis >= 3, 1, 0))
...
There are `r nrow(prec_cis_result)` participant(s) have same directions of PA and NA (both >= 3 or < 3). 
...
# compare each item with 3
postec_cis_bi <- as.data.frame(ifelse(postec_cis >= 3, 1, 0))
...
There are `r nrow(postec_cis_result)` participant(s) have same directions of PA and NA (both >= 3 or < 3). 
