---
title: "09302019 ecig T.selflaunch"
author: "Yi"
date: "10/8/2019"
output: pdf_document
---
...
library(Hmisc)
#Read Data
data=read.csv('/Users/zhan039/Desktop/USC HEAL/EVOC (CONJOINT)/DATA/Turk self-launch/ConjointAnalysisTPMT_DATA_2019-10-08_1117.csv')
#Setting Labels
...
label(data$tpmturkid)="Please enter your Mechanical Turk Worker ID:"
...
```{r}
T.selflaunch <- MergeEcigaretteUse(T.selflaunch)
```

```{r}
# E-cigarette use
# disposable device
FrequencyPercentage(T.selflaunch$ever_disp_combined.factor)
FrequencyPercentage(T.selflaunch$disp_6_month_exclude_30_days.factor)
FrequencyPercentage(T.selflaunch$disp_30_days_combined.factor)

# vape pen
FrequencyPercentage(T.selflaunch$ever_pen_combined.factor)
FrequencyPercentage(T.selflaunch$pen_6_month_exclude_30_days.factor)
FrequencyPercentage(T.selflaunch$pen_30_days_combined.factor)

# Mod or mech-mod
FrequencyPercentage(T.selflaunch$ever_mod_combined.factor)
FrequencyPercentage(T.selflaunch$mod_6_month_exclude_30_days.factor)
FrequencyPercentage(T.selflaunch$mod_30_days_combined.factor)

# Box mod
FrequencyPercentage(T.selflaunch$ever_box_mod_combined.factor)
FrequencyPercentage(T.selflaunch$box_mod_6_month_exclude_30_days.factor)
FrequencyPercentage(T.selflaunch$box_30_days_combined.factor)

# JUUl
FrequencyPercentage(T.selflaunch$ever_juul_combined.factor)
FrequencyPercentage(T.selflaunch$juul_6_month_exclude_30_days.factor)
FrequencyPercentage(T.selflaunch$juul_30_days_combined.factor)

# other pod mod
FrequencyPercentage(T.selflaunch$ever_pod_combined.factor)
FrequencyPercentage(T.selflaunch$pod_6_month_exclude_30_days.factor)
FrequencyPercentage(T.selflaunch$pod_30_days_combined.factor)
...
```{r}
# First device used
FrequencyPercentageDummy(T.selflaunch$first_disp, T.selflaunch$ever_disp_combined)

FrequencyPercentageDummy(T.selflaunch$first_pen, T.selflaunch$ever_pen_combined)

FrequencyPercentageDummy(T.selflaunch$first_mod, T.selflaunch$ever_mod_combined)

FrequencyPercentageDummy(T.selflaunch$first_box, T.selflaunch$ever_box_mod_combined)

FrequencyPercentageDummy(T.selflaunch$first_juul, T.selflaunch$ever_juul_combined)

FrequencyPercentageDummy(T.selflaunch$first_otherpod, T.selflaunch$ever_pod_combined)

FrequencyPercentageDummy(T.selflaunch$first_other, T.selflaunch$ever_other_combined)
```

```{r}
# device used most often in the past 30 days
FrequencyPercentageDummy(T.selflaunch$disp_most, T.selflaunch$last_30_ecig_dispose)

FrequencyPercentageDummy(T.selflaunch$pen_most, T.selflaunch$last_30_ecig_pen)

FrequencyPercentageDummy(T.selflaunch$mod_most, T.selflaunch$last_30_ecig_mod)

FrequencyPercentageDummy(T.selflaunch$box_most, T.selflaunch$last_30_ecig_box_mod)

FrequencyPercentageDummy(T.selflaunch$juul_most, T.selflaunch$last_30_ecig_juul)

FrequencyPercentageDummy(T.selflaunch$pod_most, T.selflaunch$last_30_ecig_pod)

FrequencyPercentageDummy(T.selflaunch$other_most, T.selflaunch$last_30_ecig_other)
```

```{r}
# Which flavor did you use the first time you vaped?
FrequencyPercentageMultilevel(T.selflaunch$flavor_first.factor, T.selflaunch$last_30_ecig_yn)
```

```{r}
# How would you best describe the types of flavors you use most often?
FrequencyPercentageMultilevel(T.selflaunch$eliq_flavor2.factor, T.selflaunch$last_30_ecig_yn)
```

```{r}
# what type of nicotine formulation do yu usually use?
FrequencyPercentageMultilevel(T.selflaunch$nic_form.factor, T.selflaunch$last_30_ecig_yn)
```

```{r}
# nicotine level
FrequencyPercentageDummy(T.selflaunch$nic_level___1, T.selflaunch$last_30_ecig_yn)
FrequencyPercentageDummy(T.selflaunch$nic_level___2, T.selflaunch$last_30_ecig_yn)
FrequencyPercentageDummy(T.selflaunch$nic_level___3, T.selflaunch$last_30_ecig_yn)
FrequencyPercentageDummy(T.selflaunch$nic_level___4, T.selflaunch$last_30_ecig_yn)
FrequencyPercentageDummy(T.selflaunch$nic_level___5, T.selflaunch$last_30_ecig_yn)
FrequencyPercentageDummy(T.selflaunch$nicotine_percent___1, T.selflaunch$last_30_ecig_yn)
FrequencyPercentageDummy(T.selflaunch$nicotine_percent___2, T.selflaunch$last_30_ecig_yn)
FrequencyPercentageDummy(T.selflaunch$nicotine_percent___3, T.selflaunch$last_30_ecig_yn)
FrequencyPercentageDummy(T.selflaunch$nicotine_percent___4, T.selflaunch$last_30_ecig_yn)
FrequencyPercentageDummy(T.selflaunch$nicotine_percent___5, T.selflaunch$last_30_ecig_yn)
FrequencyPercentageDummy(T.selflaunch$nicotine_percent___6, T.selflaunch$last_30_ecig_yn)
FrequencyPercentageDummy(T.selflaunch$nicotine_percent___7, T.selflaunch$last_30_ecig_yn)
FrequencyPercentageDummy(T.selflaunch$nicotine_percent___8, T.selflaunch$last_30_ecig_yn)
FrequencyPercentageDummy(T.selflaunch$nicotine_percent___9, T.selflaunch$last_30_ecig_yn)
```

```{r}
# Do you own, or have you ever owned, an e-cigarette device?
FrequencyPercentage(T.selflaunch$ecig_2)
```

```{r}
# Juul pods per day
round(mean(T.selflaunch$juul_usage_day, na.rm = T), 1)
round(sd(T.selflaunch$juul_usage_day, na.rm = T), 1)
summary(T.selflaunch$juul_usage_day[!is.na(T.selflaunch$juul_usage_day)])



 # Juul pods per week
round(mean(T.selflaunch$juul_usage_week, na.rm = T), 1)
round(sd(T.selflaunch$juul_usage_week, na.rm = T), 1)
summary(T.selflaunch$juul_usage_week[!is.na(T.selflaunch$juul_usage_week)])


# Juul pods per month
round(mean(T.selflaunch$juul_usage_month, na.rm = T), 1)
round(sd(T.selflaunch$juul_usage_month, na.rm = T), 1)
summary(T.selflaunch$juul_usage_month[!is.na(T.selflaunch$juul_usage_month)])

```

```{r}
# E-cigarette dependence
T.selflaunch$num.symptoms <- T.selflaunch$vape_addiction1 + T.selflaunch$vape_addiction2 + T.selflaunch$vape_addiction3 + T.selflaunch$vape_addiction4 + T.selflaunch$vape_addiction5 + T.selflaunch$vape_addiction6 + T.selflaunch$vape_quit_effects1 + T.selflaunch$vape_quit_effects2 + T.selflaunch$vape_quit_effects3 + T.selflaunch$vape_quit_effects4
label(T.selflaunch$num.symptoms) <- "How many symptoms of E-cigarette dependence?"

round(mean(T.selflaunch$num.symptoms, na.rm = T), 1)
round(sd(T.selflaunch$num.symptoms, na.rm = T), 1)
summary(T.selflaunch$num.symptoms[!is.na(T.selflaunch$num.symptoms)])


range(T.selflaunch$num.symptoms, na.rm = T)
round(NROW(which(T.selflaunch$num.symptoms >= 1))/ sum(!is.na(T.selflaunch$num.symptoms)) * 100, 1)
```

```{r}
save(T.selflaunch, file = "/Users/zhan039/Desktop/USC HEAL/EVOC (CONJOINT)/09:30:2019 needs/difference/T.selflaunch.RData")
```
