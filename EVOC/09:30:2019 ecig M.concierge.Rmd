---
title: "09302019 ecig M.concierge"
author: "Yi"
date: "10/9/2019"
output: pdf_document
---
...
library(Hmisc)
#Read Data
data=read.csv('/Users/zhan039/Desktop/USC HEAL/EVOC (CONJOINT)/DATA/Mturk concierge/ConjointAnalysisMTur_DATA_2019-10-09_1400.csv')
#Setting Labels
...
label(data$mturkidcon)="Please enter your Mechanical Turk Worker ID:"
...
```{r}
M.concierge <- MergeEcigaretteUse(M.concierge)
```

```{r}
# E-cigarette use
# disposable device
FrequencyPercentage(M.concierge$ever_disp_combined.factor)
FrequencyPercentage(M.concierge$disp_6_month_exclude_30_days.factor)
FrequencyPercentage(M.concierge$disp_30_days_combined.factor)

# vape pen
FrequencyPercentage(M.concierge$ever_pen_combined.factor)
FrequencyPercentage(M.concierge$pen_6_month_exclude_30_days.factor)
FrequencyPercentage(M.concierge$pen_30_days_combined.factor)

# Mod or mech-mod
FrequencyPercentage(M.concierge$ever_mod_combined.factor)
FrequencyPercentage(M.concierge$mod_6_month_exclude_30_days.factor)
FrequencyPercentage(M.concierge$mod_30_days_combined.factor)

# Box mod
FrequencyPercentage(M.concierge$ever_box_mod_combined.factor)
FrequencyPercentage(M.concierge$box_mod_6_month_exclude_30_days.factor)
FrequencyPercentage(M.concierge$box_30_days_combined.factor)

# JUUl
FrequencyPercentage(M.concierge$ever_juul_combined.factor)
FrequencyPercentage(M.concierge$juul_6_month_exclude_30_days.factor)
FrequencyPercentage(M.concierge$juul_30_days_combined.factor)

# other pod mod
FrequencyPercentage(M.concierge$ever_pod_combined.factor)
FrequencyPercentage(M.concierge$pod_6_month_exclude_30_days.factor)
FrequencyPercentage(M.concierge$pod_30_days_combined.factor)
...
```{r}
# First device used
FrequencyPercentageDummy(M.concierge$first_disp, M.concierge$ever_disp_combined)

FrequencyPercentageDummy(M.concierge$first_pen, M.concierge$ever_pen_combined)

FrequencyPercentageDummy(M.concierge$first_mod, M.concierge$ever_mod_combined)

FrequencyPercentageDummy(M.concierge$first_box, M.concierge$ever_box_mod_combined)

FrequencyPercentageDummy(M.concierge$first_juul, M.concierge$ever_juul_combined)

FrequencyPercentageDummy(M.concierge$first_otherpod, M.concierge$ever_pod_combined)

FrequencyPercentageDummy(M.concierge$first_other, M.concierge$ever_other_combined)
```

```{r}
# device used most often in the past 30 days
FrequencyPercentageDummy(M.concierge$disp_most, M.concierge$last_30_ecig_dispose)

FrequencyPercentageDummy(M.concierge$pen_most, M.concierge$last_30_ecig_pen)

FrequencyPercentageDummy(M.concierge$mod_most, M.concierge$last_30_ecig_mod)

FrequencyPercentageDummy(M.concierge$box_most, M.concierge$last_30_ecig_box_mod)

FrequencyPercentageDummy(M.concierge$juul_most, M.concierge$last_30_ecig_juul)

FrequencyPercentageDummy(M.concierge$pod_most, M.concierge$last_30_ecig_pod)

FrequencyPercentageDummy(M.concierge$other_most, M.concierge$last_30_ecig_other)
```

```{r}
# Which flavor did you use the first time you vaped?
FrequencyPercentageMultilevel(M.concierge$flavor_first.factor, M.concierge$last_30_ecig_yn)
```

```{r}
# How would you best describe the types of flavors you use most often?
FrequencyPercentageMultilevel(M.concierge$eliq_flavor2.factor, M.concierge$last_30_ecig_yn)
```

```{r}
# what type of nicotine formulation do yu usually use?
FrequencyPercentageMultilevel(M.concierge$nic_form.factor, M.concierge$last_30_ecig_yn)
```

```{r}
# nicotine level
FrequencyPercentageDummy(M.concierge$nic_level___1, M.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(M.concierge$nic_level___2, M.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(M.concierge$nic_level___3, M.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(M.concierge$nic_level___4, M.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(M.concierge$nic_level___5, M.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(M.concierge$nicotine_percent___1, M.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(M.concierge$nicotine_percent___2, M.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(M.concierge$nicotine_percent___3, M.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(M.concierge$nicotine_percent___4, M.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(M.concierge$nicotine_percent___5, M.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(M.concierge$nicotine_percent___6, M.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(M.concierge$nicotine_percent___7, M.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(M.concierge$nicotine_percent___8, M.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(M.concierge$nicotine_percent___9, M.concierge$last_30_ecig_yn)
```

```{r}
# Do you own, or have you ever owned, an e-cigarette device?
FrequencyPercentage(M.concierge$ecig_2)
```

```{r}
# Juul pods per day
round(mean(M.concierge$juul_usage_day, na.rm = T), 1)
round(sd(M.concierge$juul_usage_day, na.rm = T), 1)
summary(M.concierge$juul_usage_day[!is.na(M.concierge$juul_usage_day)])


# Juul pods per week
round(mean(M.concierge$juul_usage_week, na.rm = T), 1)
round(sd(M.concierge$juul_usage_week, na.rm = T), 1)
summary(M.concierge$juul_usage_week[!is.na(M.concierge$juul_usage_week)])


# Juul pods per month
round(mean(M.concierge$juul_usage_month, na.rm = T), 1)
round(sd(M.concierge$juul_usage_month, na.rm = T), 1)
summary(M.concierge$juul_usage_month[!is.na(M.concierge$juul_usage_month)])

```

```{r}
# E-cigarette dependence
M.concierge$num.symptoms <- M.concierge$vape_addiction1 + M.concierge$vape_addiction2 + M.concierge$vape_addiction3 + M.concierge$vape_addiction4 + M.concierge$vape_addiction5 + M.concierge$vape_addiction6 + M.concierge$vape_quit_effects1 + M.concierge$vape_quit_effects2 + M.concierge$vape_quit_effects3 + M.concierge$vape_quit_effects4
label(M.concierge$num.symptoms) <- "How many symptoms of E-cigarette dependence?"

round(mean(M.concierge$num.symptoms, na.rm = T), 1)
round(sd(M.concierge$num.symptoms, na.rm = T), 1)
summary(M.concierge$num.symptoms[!is.na(M.concierge$num.symptoms)])


range(M.concierge$num.symptoms, na.rm = T)
round(NROW(which(M.concierge$num.symptoms >= 1))/ sum(!is.na(M.concierge$num.symptoms)) * 100, 1)
```

```{r}
save(M.concierge, file = "/Users/zhan039/Desktop/USC HEAL/EVOC (CONJOINT)/09:30:2019 needs/difference/M.concierge.RData")
```
