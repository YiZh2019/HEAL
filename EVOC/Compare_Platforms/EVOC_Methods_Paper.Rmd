...
data[data$last_30_ecig_dispose %in% 1 & data$last_30_ecig_yn %in% 0, c("redcapid", "last_30_ecig_dispose", "last_30_ecig_yn", "disp_30_days")]
data[data$last_30_ecig_pen %in% 1 & data$last_30_ecig_yn %in% 0, c("redcapid", "last_30_ecig_pen", "last_30_ecig_yn", "pen_30_days")] 
data[data$last_30_ecig_mod %in% 1 & data$last_30_ecig_yn %in% 0, c("redcapid", "last_30_ecig_mod", "last_30_ecig_yn", "mod_30_days")]
data[data$last_30_ecig_box_mod %in% 1 & data$last_30_ecig_yn %in% 0, c("redcapid", "last_30_ecig_box_mod", "last_30_ecig_yn", "box_30_days")]
data[data$last_30_ecig_juul %in% 1 & data$last_30_ecig_yn %in% 0, c("redcapid", "last_30_ecig_juul", "last_30_ecig_yn", "box_30_days")]
data[data$last_30_ecig_pod %in% 1 & data$last_30_ecig_yn %in% 0, c("redcapid", "last_30_ecig_pod", "last_30_ecig_yn", "pod_30_days")]
...
data[data$last_30_ecig_box_mod %in% 9 & data$last_30_ecig_yn %in% 0, c("redcapid", "last_30_ecig_box_mod", "last_30_ecig_yn", "box_30_days")]
data[data$last_30_ecig_juul %in% 9 & data$last_30_ecig_yn %in% 0, c("redcapid", "last_30_ecig_juul", "last_30_ecig_yn", "box_30_days")]
data[data$last_30_ecig_pod %in% 9 & data$last_30_ecig_yn %in% 0, c("redcapid", "last_30_ecig_pod", "last_30_ecig_yn", "pod_30_days")]

## create variables 
EverUse <- function(var.ever, var.last){
  temp.data <- mutate(data, temp_ever_use_new = ifelse(get(var.ever) %in% 0, 0, 
                                            ifelse(get(var.ever) %in% 1 | get(var.ever) %in% 2 & get(var.last) != 1, 1, 
                                                   ifelse(get(var.ever) %in% 2 & get(var.last) %in% 1, 2, NA))))
