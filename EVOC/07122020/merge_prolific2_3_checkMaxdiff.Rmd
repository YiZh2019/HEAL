...
x1[x1$prolificpid == "5cc210247502a000125f9886", c("redcapid", "prolificpid", "num.na.new")]
x1 <- x1[-c(77, 78),]
...
x2[x2$prolificpid == "5a1303419b760100013a7dd9", c("redcapid", "prolificpid", "num.na.new")]
x2[x2$prolificpid == "5da2d3e256940100160c3bec", c("redcapid", "prolificpid", "num.na.new")]
x2 <- x2[-c(3, 45),]
