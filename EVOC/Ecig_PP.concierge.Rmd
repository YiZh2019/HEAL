---
title: "09302019 ecig PP.concierge"
author: "Yi"
date: "10/9/2019"
output: pdf_document
---
...
library(Hmisc)
#Read Data
data=read.csv('/Users/zhan039/Desktop/USC HEAL/EVOC (CONJOINT)/DATA/Prime Panels concierge/ConjointAnalysisPPCo_DATA_2019-10-09_1624.csv')
#Setting Labels

label(data$redcapid)="REDCap ID"
label(data$redcap_survey_identifier)="Survey Identifier"
label(data$demographics_timestamp)="Survey Timestamp"
label(data$aid)="Prime Panel Assignment ID"
...
```{r}
PP.concierge <- MergeEcigaretteUse(PP.concierge)
```

```{r}
# E-cigarette use
# disposable device
FrequencyPercentage(PP.concierge$ever_disp_combined.factor)
FrequencyPercentage(PP.concierge$disp_6_month_exclude_30_days.factor)
FrequencyPercentage(PP.concierge$disp_30_days_combined.factor)

# vape pen
FrequencyPercentage(PP.concierge$ever_pen_combined.factor)
FrequencyPercentage(PP.concierge$pen_6_month_exclude_30_days.factor)
FrequencyPercentage(PP.concierge$pen_30_days_combined.factor)

# Mod or mech-mod
FrequencyPercentage(PP.concierge$ever_mod_combined.factor)
FrequencyPercentage(PP.concierge$mod_6_month_exclude_30_days.factor)
FrequencyPercentage(PP.concierge$mod_30_days_combined.factor)

# Box mod
FrequencyPercentage(PP.concierge$ever_box_mod_combined.factor)
FrequencyPercentage(PP.concierge$box_mod_6_month_exclude_30_days.factor)
FrequencyPercentage(PP.concierge$box_30_days_combined.factor)

# JUUl
FrequencyPercentage(PP.concierge$ever_juul_combined.factor)
FrequencyPercentage(PP.concierge$juul_6_month_exclude_30_days.factor)
FrequencyPercentage(PP.concierge$juul_30_days_combined.factor)

# other pod mod
FrequencyPercentage(PP.concierge$ever_pod_combined.factor)
FrequencyPercentage(PP.concierge$pod_6_month_exclude_30_days.factor)
FrequencyPercentage(PP.concierge$pod_30_days_combined.factor)
...
```{r}
# First device used
FrequencyPercentageDummy(PP.concierge$first_disp, PP.concierge$ever_disp_combined)

FrequencyPercentageDummy(PP.concierge$first_pen, PP.concierge$ever_pen_combined)

FrequencyPercentageDummy(PP.concierge$first_mod, PP.concierge$ever_mod_combined)

FrequencyPercentageDummy(PP.concierge$first_box, PP.concierge$ever_box_mod_combined)

FrequencyPercentageDummy(PP.concierge$first_juul, PP.concierge$ever_juul_combined)

FrequencyPercentageDummy(PP.concierge$first_otherpod, PP.concierge$ever_pod_combined)

FrequencyPercentageDummy(PP.concierge$first_other, PP.concierge$ever_other_combined)
```

```{r}
# device used most often in the past 30 days
FrequencyPercentageDummy(PP.concierge$disp_most, PP.concierge$last_30_ecig_dispose)

FrequencyPercentageDummy(PP.concierge$pen_most, PP.concierge$last_30_ecig_pen)

FrequencyPercentageDummy(PP.concierge$mod_most, PP.concierge$last_30_ecig_mod)

FrequencyPercentageDummy(PP.concierge$box_most, PP.concierge$last_30_ecig_box_mod)

FrequencyPercentageDummy(PP.concierge$juul_most, PP.concierge$last_30_ecig_juul)

FrequencyPercentageDummy(PP.concierge$pod_most, PP.concierge$last_30_ecig_pod)

FrequencyPercentageDummy(PP.concierge$other_most, PP.concierge$last_30_ecig_other)
```

```{r}
# Which flavor did you use the first time you vaped?
FrequencyPercentageMultilevel(PP.concierge$flavor_first.factor, PP.concierge$last_30_ecig_yn)
```

```{r}
# How would you best describe the types of flavors you use most often?
FrequencyPercentageMultilevel(PP.concierge$eliq_flavor2.factor, PP.concierge$last_30_ecig_yn)
```

```{r}
# what type of nicotine formulation do yu usually use?
FrequencyPercentageMultilevel(PP.concierge$nic_form.factor, PP.concierge$last_30_ecig_yn)
```

```{r}
# nicotine level
FrequencyPercentageDummy(PP.concierge$nic_level___1, PP.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(PP.concierge$nic_level___2, PP.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(PP.concierge$nic_level___3, PP.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(PP.concierge$nic_level___4, PP.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(PP.concierge$nic_level___5, PP.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(PP.concierge$nicotine_percent___1, PP.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(PP.concierge$nicotine_percent___2, PP.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(PP.concierge$nicotine_percent___3, PP.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(PP.concierge$nicotine_percent___4, PP.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(PP.concierge$nicotine_percent___5, PP.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(PP.concierge$nicotine_percent___6, PP.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(PP.concierge$nicotine_percent___7, PP.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(PP.concierge$nicotine_percent___8, PP.concierge$last_30_ecig_yn)
FrequencyPercentageDummy(PP.concierge$nicotine_percent___9, PP.concierge$last_30_ecig_yn)
```

```{r}
# Do you own, or have you ever owned, an e-cigarette device?
FrequencyPercentage(PP.concierge$ecig_2)
```

```{r}
# Juul pods per day
round(mean(PP.concierge$juul_usage_day, na.rm = T), 1)
round(sd(PP.concierge$juul_usage_day, na.rm = T), 1)
summary(PP.concierge$juul_usage_day[!is.na(PP.concierge$juul_usage_day)])


# Juul pods per week
round(mean(PP.concierge$juul_usage_week, na.rm = T), 1)
round(sd(PP.concierge$juul_usage_week, na.rm = T), 1)
summary(PP.concierge$juul_usage_week[!is.na(PP.concierge$juul_usage_week)])


# Juul pods per month
round(mean(PP.concierge$juul_usage_month, na.rm = T), 1)
round(sd(PP.concierge$juul_usage_month, na.rm = T), 1)
summary(PP.concierge$juul_usage_month[!is.na(PP.concierge$juul_usage_month)])

```

```{r}
# E-cigarette dependence
PP.concierge$num.symptoms <- PP.concierge$vape_addiction1 + PP.concierge$vape_addiction2 + PP.concierge$vape_addiction3 + PP.concierge$vape_addiction4 + PP.concierge$vape_addiction5 + PP.concierge$vape_addiction6 + PP.concierge$vape_quit_effects1 + PP.concierge$vape_quit_effects2 + PP.concierge$vape_quit_effects3 + PP.concierge$vape_quit_effects4
label(PP.concierge$num.symptoms) <- "How many symptoms of E-cigarette dependence?"

round(mean(PP.concierge$num.symptoms, na.rm = T), 1)
round(sd(PP.concierge$num.symptoms, na.rm = T), 1)
summary(PP.concierge$num.symptoms[!is.na(PP.concierge$num.symptoms)])


range(PP.concierge$num.symptoms, na.rm = T)
round(NROW(which(PP.concierge$num.symptoms >= 1))/ sum(!is.na(PP.concierge$num.symptoms)) * 100, 1)
```

```{r}
save(PP.concierge, file = "/Users/zhan039/Desktop/USC HEAL/EVOC (CONJOINT)/09:30:2019 needs/difference/PP.concierge.RData")
```
