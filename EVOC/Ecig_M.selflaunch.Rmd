---
title: "09302019 ecig M.selflauch"
author: "Yi"
date: "10/8/2019"
output: pdf_document
---
...
library(Hmisc)
#Read Data
data=read.csv('/Users/zhan039/Desktop/USC HEAL/EVOC (CONJOINT)/DATA/Mturk self-launch/ConjointAnalysisMTur_DATA_2019-10-07_1737.csv')
#Setting Labels
...
label(data$mturkid)="Please enter your Mechanical Turk Worker ID:"
...
```{r}
M.selflauch <- MergeEcigaretteUse(M.selflauch)
```

```{r}
# E-cigarette use
# disposable device
FrequencyPercentage(M.selflauch$ever_disp_combined.factor)
FrequencyPercentage(M.selflauch$disp_6_month_exclude_30_days.factor)
FrequencyPercentage(M.selflauch$disp_30_days_combined.factor)

# vape pen
FrequencyPercentage(M.selflauch$ever_pen_combined.factor)
FrequencyPercentage(M.selflauch$pen_6_month_exclude_30_days.factor)
FrequencyPercentage(M.selflauch$pen_30_days_combined.factor)

# Mod or mech-mod
FrequencyPercentage(M.selflauch$ever_mod_combined.factor)
FrequencyPercentage(M.selflauch$mod_6_month_exclude_30_days.factor)
FrequencyPercentage(M.selflauch$mod_30_days_combined.factor)

# Box mod
FrequencyPercentage(M.selflauch$ever_box_mod_combined.factor)
FrequencyPercentage(M.selflauch$box_mod_6_month_exclude_30_days.factor)
FrequencyPercentage(M.selflauch$box_30_days_combined.factor)

# JUUl
FrequencyPercentage(M.selflauch$ever_juul_combined.factor)
FrequencyPercentage(M.selflauch$juul_6_month_exclude_30_days.factor)
FrequencyPercentage(M.selflauch$juul_30_days_combined.factor)

# other pod mod
FrequencyPercentage(M.selflauch$ever_pod_combined.factor)
FrequencyPercentage(M.selflauch$pod_6_month_exclude_30_days.factor)
FrequencyPercentage(M.selflauch$pod_30_days_combined.factor)
...
```{r}
# First device used
FrequencyPercentageDummy(M.selflauch$first_disp, M.selflauch$ever_disp_combined)

FrequencyPercentageDummy(M.selflauch$first_pen, M.selflauch$ever_pen_combined)

FrequencyPercentageDummy(M.selflauch$first_mod, M.selflauch$ever_mod_combined)

FrequencyPercentageDummy(M.selflauch$first_box, M.selflauch$ever_box_mod_combined)

FrequencyPercentageDummy(M.selflauch$first_juul, M.selflauch$ever_juul_combined)

FrequencyPercentageDummy(M.selflauch$first_otherpod, M.selflauch$ever_pod_combined)

FrequencyPercentageDummy(M.selflauch$first_other, M.selflauch$ever_other_combined)
```

```{r}
# device used most often in the past 30 days
FrequencyPercentageDummy(M.selflauch$disp_most, M.selflauch$last_30_ecig_dispose)

FrequencyPercentageDummy(M.selflauch$pen_most, M.selflauch$last_30_ecig_pen)

FrequencyPercentageDummy(M.selflauch$mod_most, M.selflauch$last_30_ecig_mod)

FrequencyPercentageDummy(M.selflauch$box_most, M.selflauch$last_30_ecig_box_mod)

FrequencyPercentageDummy(M.selflauch$juul_most, M.selflauch$last_30_ecig_juul)

FrequencyPercentageDummy(M.selflauch$pod_most, M.selflauch$last_30_ecig_pod)

FrequencyPercentageDummy(M.selflauch$other_most, M.selflauch$last_30_ecig_other)
```

```{r}
# Which flavor did you use the first time you vaped?
FrequencyPercentageMultilevel(M.selflauch$flavor_first.factor, M.selflauch$last_30_ecig_yn)
```

```{r}
# How would you best describe the types of flavors you use most often?
FrequencyPercentageMultilevel(M.selflauch$eliq_flavor2.factor, M.selflauch$last_30_ecig_yn)
```

```{r}
# what type of nicotine formulation do yu usually use?
FrequencyPercentageMultilevel(M.selflauch$nic_form.factor, M.selflauch$last_30_ecig_yn)
```

```{r}
# nicotine level
FrequencyPercentageDummy(M.selflauch$nic_level___1, M.selflauch$last_30_ecig_yn)
FrequencyPercentageDummy(M.selflauch$nic_level___2, M.selflauch$last_30_ecig_yn)
FrequencyPercentageDummy(M.selflauch$nic_level___3, M.selflauch$last_30_ecig_yn)
FrequencyPercentageDummy(M.selflauch$nic_level___4, M.selflauch$last_30_ecig_yn)
FrequencyPercentageDummy(M.selflauch$nic_level___5, M.selflauch$last_30_ecig_yn)
FrequencyPercentageDummy(M.selflauch$nicotine_percent___1, M.selflauch$last_30_ecig_yn)
FrequencyPercentageDummy(M.selflauch$nicotine_percent___2, M.selflauch$last_30_ecig_yn)
FrequencyPercentageDummy(M.selflauch$nicotine_percent___3, M.selflauch$last_30_ecig_yn)
FrequencyPercentageDummy(M.selflauch$nicotine_percent___4, M.selflauch$last_30_ecig_yn)
FrequencyPercentageDummy(M.selflauch$nicotine_percent___5, M.selflauch$last_30_ecig_yn)
FrequencyPercentageDummy(M.selflauch$nicotine_percent___6, M.selflauch$last_30_ecig_yn)
FrequencyPercentageDummy(M.selflauch$nicotine_percent___7, M.selflauch$last_30_ecig_yn)
FrequencyPercentageDummy(M.selflauch$nicotine_percent___8, M.selflauch$last_30_ecig_yn)
FrequencyPercentageDummy(M.selflauch$nicotine_percent___9, M.selflauch$last_30_ecig_yn)
```

```{r}
# Do you own, or have you ever owned, an e-cigarette device?
FrequencyPercentage(M.selflauch$ecig_2)
```

```{r}
# Juul pods per day
round(mean(M.selflauch$juul_usage_day, na.rm = T), 1)
round(sd(M.selflauch$juul_usage_day, na.rm = T), 1)
summary(M.selflauch$juul_usage_day[!is.na(M.selflauch$juul_usage_day)])


# Juul pods per week
round(mean(M.selflauch$juul_usage_week, na.rm = T), 1)
round(sd(M.selflauch$juul_usage_week, na.rm = T), 1)
summary(M.selflauch$juul_usage_week[!is.na(M.selflauch$juul_usage_week)])


# Juul pods per month
round(mean(M.selflauch$juul_usage_month, na.rm = T), 1)
round(sd(M.selflauch$juul_usage_month, na.rm = T), 1)
summary(M.selflauch$juul_usage_month[!is.na(M.selflauch$juul_usage_month)])

```

```{r}
# E-cigarette dependence
M.selflauch$num.symptoms <- M.selflauch$vape_addiction1 + M.selflauch$vape_addiction2 + M.selflauch$vape_addiction3 + M.selflauch$vape_addiction4 + M.selflauch$vape_addiction5 + M.selflauch$vape_addiction6 + M.selflauch$vape_quit_effects1 + M.selflauch$vape_quit_effects2 + M.selflauch$vape_quit_effects3 + M.selflauch$vape_quit_effects4
label(M.selflauch$num.symptoms) <- "How many symptoms of E-cigarette dependence?"

round(mean(M.selflauch$num.symptoms, na.rm = T), 1)
round(sd(M.selflauch$num.symptoms, na.rm = T), 1)
summary(M.selflauch$num.symptoms[!is.na(M.selflauch$num.symptoms)])


range(M.selflauch$num.symptoms, na.rm = T)
round(NROW(which(M.selflauch$num.symptoms >= 1))/ sum(!is.na(M.selflauch$num.symptoms)) * 100, 1)
```

```{r}
save(M.selflauch, file = "/Users/zhan039/Desktop/USC HEAL/EVOC (CONJOINT)/09:30:2019 needs/difference/M.sellflaunch.Rdata")
```
